...
var zhTW = map[string]string{
	...
	"help.zoom.issues":    "這個面板 repo 的 GitHub issues",
	...
	"help.group.issues":        "聚焦面板 repo 的 GitHub issues",
	...
	"bind.relaunch":       "依現行設定重新啟動選取範圍內已結束的面板",
	...
	"bind.issues":         "這個面板 repo 的 GitHub issues（看板 · 派工 · 排隊）",
	"bind.issues.short":   "issues",
	...
	// The projects table (p inside the usage overlay): spend by project, in the
	// window and in the week, across every agent baton can read.
	"usage.view.no-projects":     "沒有各專案的數字 — daemon 版本較舊，或還沒有任何用量",
	"usage.view.project":         "專案",
	"usage.view.project-session": "工作階段",
	"usage.view.project-week":    "本週",
	"usage.view.more-projects":   "還有 %d 個",
	"usage.view.week-is":         "本週：",
	"usage.view.last-7d":         "最近 7 天",
	"usage.view.since":           "自 %s 起",
	"usage.legend.projects":      "專案",
	"usage.legend.panels":        "面板",
	...
	"input.issue-block.title":    "被誰擋住",
	"input.issue-block.prompt":   "擋住這張卡的 issue 編號",
	"input.issue-mile.title":     "找 milestone",
	"input.issue-mile.prompt":    "milestone 名稱（子字串，enter 選定）",
	...
	"status.re-launching":                    "正在依現行設定重新啟動 ",
	"status.re-launching-d-panel":            "正在依現行設定重新啟動 %[2]s 裡的 %[1]d 個面板",
	...
	"issues.status.loading":           "issues · 正在抓 GitHub",
	"issues.status.closed":            "issues 已關閉",
	"issues.status.select-panel":      "issues: 請選一個面板",
	"issues.status.not-conductor":     "issues: conductor 的 workspace 不是專案 repo",
	"issues.status.no-cwd":            "issues: 這個面板沒有工作目錄",
	"issues.status.failed":            "issues 失敗：",
	"issues.status.open-n":            "issues · %s · %d 張未關",
	"issues.status.empty-column":      "issues: 這一欄沒有卡",
	"issues.status.no-handling-panel": "沒有 handling panel",
	"issues.status.bound":             "已把 #%d 綁到這個面板",
	"issues.status.no-current":        "這個 branch 沒有 issue 或 PR · space 詳情 · b 綁定",
	"issues.status.mile":              "issues · %s · BACKLOG %d · IN PROCESS %d · PR %d 張",
	"issues.status.mile-pick":         "tab 切換 · esc 結束",
	"issues.status.mile-search":       "milestone · 輸入名稱 · enter 選定",
	"issues.status.mile-none":         "issues: 沒有唯一的 milestone 符合",
	"issues.status.block-prompt":      "blocked-by · issue 編號",
	"issues.status.block-need-number": "blocked-by: 需要 issue 編號",
	"issues.fetched.never":            "尚未抓取",
	"issues.fetched.ago":              "%s 前抓取",
	"issues.fetched.loading":          "抓取中",
	"issues.banner.loading":           "正在抓 GitHub…",
	"issues.milestone.none":           "（無）",
	"issues.header.counts":            "milestone  %s     未關 %d  ·  已關 %d  ·  %s",
	"issues.header.repo":              "%s  ·  GitHub  ·  %s",
	"issues.clipped":                  "↕ 還有",
	"issues.legend.board":             "tab/←→ 欄  ·  ↑/↓ 卡  ·  m / milestone  ·  space/enter 詳情  ·  p 面板  ·  r 重整  ·  esc",
	"issues.legend.mile-pick":         "tab 切換  ·  S-tab 上一個  ·  m/esc 結束",
	"issues.detail.back":              "← esc 回看板",
	"issues.detail.meta":              "#%d    %s\n%s   ·  %s  ·  %s\n父  %s     PR %s     被擋  %s     子項  %s",
	"issues.legend.detail":            "T 派工  ·  t 排隊  ·  b 綁定  ·  B 擋住  ·  p 面板  ·  r 重整  ·  enter  ·  esc",
	"legend.keep":                     "保留",
	"legend.clear":                    "清除",
	"legend.enter-dir":                "進入",
	"legend.up":                       "上一層",
