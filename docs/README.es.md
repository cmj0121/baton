...
En Linux, coge un tarball precompilado de las [releases](https://github.com/cmj0121/baton/releases) — o, en cualquier
plataforma, consíguelo con [Go](https://go.dev) 1.26+:
